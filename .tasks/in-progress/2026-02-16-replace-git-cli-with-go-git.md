...
- 2026-07-31: github.com/go-git/go-git/v6 v6.0.0-alpha.5.0.20260730134444-cf4d91c78c32, github.com/go-git/go-billy/v6 v6.0.0-alpha.2.0.20260728104803-133d4f9bfd41; Test B still blocked after re-running the validation loop; the patched run failed in integration tests with 14 failures, and the patch was reverted.
